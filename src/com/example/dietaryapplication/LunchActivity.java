...
public class LunchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.recommend_lunch);		
...
//		int dateCompare=0;
		...
		try {
		 ...
		 Log.i("DATECOMP", "Current: "+ currentDateStr);
		 Log.i("DATECOMP", "SelectedDate: "+ selectedDate);
	...
	private void initFoodItems(boolean isEmpty){
		...
		if(isEmpty){			
			...
			dr = new DailyRecommendation(DailyRecommendation.LUNCH, selectedDate, (int)tea.getTEAid(),
...
//			Toast.makeText(getApplicationContext(), "date: "+selectedDate  + "False", Toast.LENGTH_SHORT).show();			
	...
	private boolean dbQuery(){
		...
		drList = dbHelper.getDailyRecommendation(selectedDate, DailyRecommendation.LUNCH);
	...
	private void initButtons(){
		...
		tv2ndServing = (TextView)findViewById(R.id.tvSecondServing);
...
//				Intent i = new Intent(LunchActivity.this, PriceActivity.class);
...
//				startActivity(i);
		...
		imgBtnOK.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(LunchActivity.this, DinnerActivity.class);
				i.putExtra("user", user);				
		...
		imgBtnShuffle.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Log.i("DATECompare", "Dc: " +dateCompare);
				if(dateCompare>0){
	...
	private void initValues(boolean isVegetarian){
		if(!isRecommendEmpty || dateCompare<=0){
			if(isVegetarian){
				...
				Log.i("TEABREAKFAST","mm: "+meat.getMeasurement());
				Log.i("TEABREAKFAST","tm: "+tea.getMeat());
				Log.i("TEABREAKFAST","mu: "+meat.getUnit());
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		super.onBackPressed();
		Intent i = new Intent(LunchActivity.this, BreakfastActivity.class);
		i.putExtra("user", user);				
		i.putExtra("date", selectedDate);
		i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
		startActivity(i);
